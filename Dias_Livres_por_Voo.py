...
st.session_state.aba_sheet = 'Configurações Noronha'

st.session_state.titulo = 'Dias Livres por Voo - Noronha'

st.session_state.titulo_2 = 'Dias Livres por Hotel - Noronha'

st.session_state.titulo_3 = 'Dias Livres Acumulados por Hotel - Noronha'

st.session_state.titulo_4 = 'Aproveitamento Dias Livres - Noronha'
